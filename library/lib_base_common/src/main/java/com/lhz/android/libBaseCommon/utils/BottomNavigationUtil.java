...
//                item.setShiftingMode(false); //api 28之前
            ...
            Logger.getLogger("BottomNavigationUtil").warning("Unable to get shift mode field");
        } catch (IllegalAccessException e) {
            Logger.getLogger("BottomNavigationUtil").warning("Unable to change value of shift mode");
        }
    }
