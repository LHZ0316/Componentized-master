...
public class DownloadManager {
    ...
    private static void sendNotify() {
        ...
        NotifyManager.show(mContext, "", "", mNotifiviews, NotifyManager.NEW_MESSAGE, null);
    }
    ...
    private static void finishNotify() {
        ...
        NotifyManager.show(mContext, "", "", mNotifiviews, NotifyManager.NEW_MESSAGE, contentIntent);
    }
