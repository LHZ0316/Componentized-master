...
import com.lhz.android.libBaseCommon.utils.BaseSP;
...
public class InterceptorUtil {
    ...
    private void handleHeaders(Request.Builder request, Context context) {
        ...
        request.addHeader(HeadersPublic.CHANNEL, BaseSP.getChannel(context));
        request.addHeader(HeadersPublic.CHANNEL_SIGNA, getSigna(BaseSP.getChannel(context)));
        request.addHeader(HeadersPublic.TOKEN, String.valueOf(BaseSPUtils.get(context, HeadersPublic.TOKEN, "")));
