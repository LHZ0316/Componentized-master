...
public class DateUtil {
    ...
    public static String getWholeTime(long date) {
        int[] details = DateUtil.getWholeDetail(date);
    ...
    public static int getAge(Date birthday) {
        ...
        if (birthday.getYear() > getDateDetail(System.currentTimeMillis())[0]) {
            birthday.setYear(birthday.getYear() - DateUtil.SYSTEM_START_DATE[0]);
        }
    ...
    public static String getSmartBirthday(int[] birthdayDetails) {
        ...
        if (birthdayDetails[0] > DateUtil.SYSTEM_START_DATE[0]) {
            birthdayDetails[0] = birthdayDetails[0] - DateUtil.SYSTEM_START_DATE[0];
        }
    ...
    public static String getSmartBirthday(Date birthday) {
        ...
        return getSmartBirthday(birthday.getTime(), false) + " " + (DateUtil
