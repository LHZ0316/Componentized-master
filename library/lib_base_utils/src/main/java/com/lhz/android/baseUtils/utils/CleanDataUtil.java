...
public class CleanDataUtil {
    ...
    public static String getAllCacheSize(Context context) {
        long cacheSize = FileUtil.getFileLen(context.getCacheDir());
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            cacheSize += FileUtil.getFileLen(context.getExternalCacheDir());
        }
    ...
    public static void clearAllCache(Context context) {
        FileUtil.delFilesFromPath(context.getCacheDir());
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            FileUtil.delFilesFromPath(context.getExternalCacheDir());
        }
    }
...
//            return size + "Byte";
    ...
    public static void cleanCustomCache(String filePath) {
        FileUtil.deleteFilesByDirectory(new File(filePath));
    }
