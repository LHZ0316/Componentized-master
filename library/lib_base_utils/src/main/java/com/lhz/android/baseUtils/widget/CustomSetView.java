 ...
 * 自定义设置条控件
 */
public final class CustomSetView extends FrameLayout {

    private final TextView mLeftView;
    private final TextView mRightView;
    private final View mLineView;

    public CustomSetView(Context context) {
        this(context, null);
    }

    public CustomSetView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomSetView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (getBackground() == null) {
            Drawable drawable = ContextCompat.getDrawable(getContext(), R.drawable.widget_set_bg_selector);
     ...
     * 设置左边的标题
     */
    public CustomSetView setLeftText(@StringRes int id) {
        return setLeftText(getResources().getString(id));
    }

    public CustomSetView setLeftText(CharSequence text) {
     ...
     * 设置左边的提示
     */
    public CustomSetView setLeftHint(@StringRes int id) {
        return setLeftHint(getResources().getString(id));
    }

    public CustomSetView setLeftHint(CharSequence hint) {
     ...
     * 设置右边的标题
     */
    public CustomSetView setRightText(@StringRes int id) {
        setRightText(getResources().getString(id));
        return this;
    }

    public CustomSetView setRightText(CharSequence text) {
     ...
     * 设置右边的提示
     */
    public CustomSetView setRightHint(@StringRes int id) {
        return setRightHint(getResources().getString(id));
    }

    public CustomSetView setRightHint(CharSequence hint) {
     ...
     * 设置左边的图标
     */
    public CustomSetView setLeftIcon(@DrawableRes int id) {
        setLeftIcon(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public CustomSetView setLeftIcon(Drawable drawable) {
     ...
     * 设置右边的图标
     */
    public CustomSetView setRightIcon(@DrawableRes int id) {
        setRightIcon(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public CustomSetView setRightIcon(Drawable drawable) {
     ...
     * 设置左标题颜色
     */
    public CustomSetView setLeftColor(@ColorInt int color) {
     ...
     * 设置右标题颜色
     */
    public CustomSetView setRightColor(@ColorInt int color) {
     ...
     * 设置左标题的文本大小
     */
    public CustomSetView setLeftSize(int unit, float size) {
     ...
     * 设置右标题的文本大小
     */
    public CustomSetView setRightSize(int unit, float size) {
     ...
     * 设置分割线是否显示
     */
    public CustomSetView setLineVisible(boolean visible) {
     ...
     * 设置分割线的颜色
     */
    public CustomSetView setLineColor(@ColorInt int color) {
        return setLineDrawable(new ColorDrawable(color));
    }

    public CustomSetView setLineDrawable(Drawable drawable) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
     ...
     * 设置分割线的大小
     */
    public CustomSetView setLineSize(int size) {
     ...
     * 设置分割线边界
     */
    public CustomSetView setLineMargin(int margin) {
