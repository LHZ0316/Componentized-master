 ...
 * 自定义开关按钮
 */
public final class CustomSwitchButton extends View {
    ...
    public CustomSwitchButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(CustomSwitchButton button, boolean isChecked);
    }
